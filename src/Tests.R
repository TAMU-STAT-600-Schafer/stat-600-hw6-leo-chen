...
out_c = LRMultiClass_c(X, Y, Xt, Yt, numIter = 500, eta = 0.1, lambda = 1)
all.equal(out$beta, out_c$beta)
all.equal(out$objective, out_c$objective)

out = LRMultiClass(X, Y, Xt, Yt, numIter = 50, eta = 0.5, lambda = 1) # larger eta
out_c = LRMultiClass_c(X, Y, Xt, Yt, numIter = 50, eta = 0.5, lambda = 1)
all.equal(out$beta, out_c$beta)
all.equal(out$objective, out_c$objective)

out = LRMultiClass(X, Y, Xt, Yt, numIter = 50, eta = 0.01, lambda = 1) # smaller eta
out_c = LRMultiClass_c(X, Y, Xt, Yt, numIter = 50, eta = 0.01, lambda = 1)
all.equal(out$beta, out_c$beta)
all.equal(out$objective, out_c$objective)

out = LRMultiClass(X, Y, Xt, Yt, numIter = 50, eta = 0.5, lambda = 5) # larger lambda
out_c = LRMultiClass_c(X, Y, Xt, Yt, numIter = 50, eta = 0.5, lambda = 5)
all.equal(out$beta, out_c$beta)
all.equal(out$objective, out_c$objective)

out = LRMultiClass(X, Y, Xt, Yt, numIter = 50, eta = 0.5, lambda = 0.5) # smaller lambda
out_c = LRMultiClass_c(X, Y, Xt, Yt, numIter = 50, eta = 0.5, lambda = 0.5)
all.equal(out$beta, out_c$beta)
all.equal(out$objective, out_c$objective)
...
out_c = LRMultiClass_c(X, Y, Xt, Yt, numIter = 50, eta = 0.1, lambda = 1, beta_init = matrix(1, ncol(X), length(unique(Y))))
